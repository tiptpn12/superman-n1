            ...
            @if($hakakses == 1)
              ...
              <div class="tab-pane fade in active" id="tab-operator-bagian">
                <div class="panel-heading">
                  <h3 class="panel-title">Tabel SPP Khusus</h3>
                </div>
                <div class="panel-body">
                  <a class="btn btn-primary" href="{{ url('spp_keuangan/tambah') }}" style="margin-bottom: 15px">Buat SPP</a>
                      ...
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @foreach($data as $d => $s)
                          ...
                          <tr>
                            ...
                            <td>
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$s->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
                              <button type="button" class="btn btn-primary btn-sm" onclick="window.open('{{ url('spp_keuangan/cetak/'.$s->spp_id) }}').print();" title="Cetak"><i class="fa fa-print"></i></button>
                              ...
                              <a type="button" class="btn btn-warning btn-sm" href="{{ url('spp_keuangan/edit/'.$s->spp_id) }}" title="Edit Data" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                              @endif
                          ...
                          <tr>
                            ...
                            <td>{{$status_revisi[$d]}} {{$posisi[$d]->master_hak_akses_keterangan}}</td>
                            <td>
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$s->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
                              <button type="button" class="btn btn-primary btn-sm" onclick="window.open('{{ url('spp_keuangan/cetak/'.$s->spp_id) }}').print();" title="Cetak"><i class="fa fa-print"></i></button>
                              <button type="button" class="btn btn-info btn-sm" onclick="upload_dokumen_pendukung({{$s->spp_id}})" title="Upload Dokumen Tambahan" ><i class="fa fa-upload"></i></button>
                      ...
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @foreach($data_batal as $d => $s)
                          <tr>
                            ...
                            <td>
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$s->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
                              <button type="button" class="btn btn-primary btn-sm" onclick="rekam_jejak({{ json_encode( $rekam_jejak_batal[$d] )}},{{json_encode($asal[$d])}})" title="Rekam Jejak" ><i class="fa fa-map-o"></i></button>
                            </td>
                          </tr>
                        @endforeach
                        </tbody>
              ...
              <div class="tab-pane fade in active" id="tab-kepala-bagian">
                ...
                <div class="panel-body">
                  ...
                  <div class="tab-content">
                    ...
                    {{-- Panel Sedang Proses --}}
                    <div class="tab-pane fade in active" id="tab-sedang-proses-petugas">
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        <thead>
                          <tr>
                            <th rowspan="2">No. </th>
                    ...
                    {{-- Panel Sudah Selesai --}}
                    <div class="tab-pane fade" id="tab-sudah-selesai-petugas">
                    <button class="btn btn-primary" onclick="advanced_search(2)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        <thead>
                          <tr>
                            <th rowspan="2"><center>No. </center></th>
                    ...
                    {{-- Panel Dibatalkan --}}
                    <div class="tab-pane fade" id="tab-dibatalkan-petugas">
                    <button class="btn btn-primary" onclick="advanced_search(3)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        <thead>
                          <tr>
                            <th rowspan="2"><center>No. </center></th>
                  ...
                  <div class="tab-content">
                    ...
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $a=1 @endphp
                        @foreach($data as $d => $s)
                        @if($s->spp_status_proses < 3 && $s->spp_status_ob < 3 && $s->spp_status_ob != 2 && ($status_revisi[$d] == '' || $status_revisi[$d] == 'Revisi oleh'))
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$s->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($s->tanggal))}}</strong></td>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-success btn-sm" onclick="terima({{$s->spp_id}})" title="Terima" ><i class="fa fa-check"></i></button>                            
                              @endif
                          ...
                          @endforeach
                          @foreach($data as $d => $s)
                          @if($s->spp_status_proses < 3 && $s->spp_status_ob == 2 && $status_revisi[$d] =='Revisi oleh')
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$s->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($s->tanggal))}}</strong></td>
                  ...
                  <div class="tab-content">
                    ...
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $a=1 @endphp
                        @foreach($data as $s => $d)
                        @if($d->spp_status_proses < 5 && $d->spp_status_ob < 3 && $d->spp_status_ob != 2 && ($status_revisi[$s] == '' || $status_revisi[$s] == 'Revisi oleh'))
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-success btn-sm" onclick="terima({{$d->spp_id}})" title="Terima" ><i class="fa fa-check"></i></button>                            
                              @endif
                              ...
                              @endif
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$d->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
                          ...
                          @endforeach
                          @foreach($data as $s => $d)
                          @if($d->spp_status_proses < 5 && $d->spp_status_ob == 2 && $status_revisi[$s] == '')
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$d->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($d->tanggal))}}</strong></td>
                  ...
                  <div class="tab-content">
                    ...
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $a=1 @endphp
                        @foreach($data as $d => $s)
                        @if($s->spp_status_proses < 7 && $s->spp_status_ob < 3 && $s->spp_status_ob != 2 && ($status_revisi[$d] == '' || $status_revisi[$d] == 'Revisi oleh'))
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$s->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($s->tanggal))}}</strong></td>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="tab-sedang-proses-petugas">
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $a=1 @endphp
                        @foreach($data as $d => $s)
                        @if($s->spp_status_proses < 9 && $s->spp_status_ob < 3 && $s->spp_status_ob != 2 && ($status_revisi[$d] == '' || $status_revisi[$d] == 'Revisi oleh'))
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$s->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($s->tanggal))}}</strong></td>
                  ...
                  <div class="tab-content">
                    ...
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $a=1 @endphp
                        @foreach($data as $d => $s)
                        @if($s->spp_status_proses < 11 && $s->spp_status_ob < 3 && $s->spp_status_ob != 2 && ($status_revisi[$d] == '' || $status_revisi[$d] == 'Revisi oleh'))
                          <tr>
                            <td><strong>{{$a++}}</strong></td>
                            <td><strong>{{$s->master_bagian_nama}}</strong></td>
                            <td><strong>{{date('d-m-Y',strtotime($s->tanggal))}}</strong></td>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-warning btn-sm" onclick="revisi({{$s->spp_id}})" title="Revisi" ><i class="fa fa-arrow-left"></i></button>
                                ...
                                @if(isset($s->sppb_no) && empty($s->sppn_no))
                                  @if($s->nomor_byr == null)
                                    <button type="button" class="btn btn-warning btn-sm" style="background-color: #FF9000; border-color: #FF9000" title="Bukti Kas"  onclick="cetak_bukti_kas(0,{{$s->sppb_id}},0,0,0,0)"><i class="fa fa-money"></i></button>
                                    @php $a=0 @endphp
                                  @elseif($s->nomor_byr != null)
                                    <button type="button" class="btn btn-primary btn-sm" style="background-color: #6E00FF;border-color: #6E00FF" title="Bukti Kas" onclick="cetak_bukti_kas({{$s->spp_id}},{{$s->sppb_id}},0,0,{{ json_encode($sppb_cetak_bukti_kas[$d]) }},0)"><i class="fa fa-money"></i></button>
                                    @php $a=1 @endphp
                                  @endif
                                @elseif(empty($s->sppb_no) && isset($s->sppn_no))
                                  @if($s->nomor_pnr == null)
                                    <button type="button" class="btn btn-warning btn-sm" style="background-color: #FF9000;border-color: #FF9000" title="Bukti Kas" onclick="cetak_bukti_kas(0,0,{{$s->sppn_id}},1,0,0)"><i class="fa fa-money"></i></button>
                                    @php $a=0 @endphp
                                  @elseif($s->nomor_pnr != null)
                                    <button type="button" class="btn btn-primary btn-sm" style="background-color: #6E00FF;border-color: #6E00FF" title="Bukti Kas" onclick="cetak_bukti_kas({{$s->spp_id}},0,{{$s->sppn_id}},1,0,{{ json_encode($sppn_cetak_bukti_kas[$d]) }})"><i class="fa fa-money"></i></button>
                                    @php $a=1 @endphp
                                  @endif
                                @elseif(isset($s->sppb_no) && isset($s->sppn_no))
                                  @if($s->nomor_byr == null && $s->nomor_pnr == null)
                                    <button type="button" class="btn btn-warning btn-sm" style="background-color: #FF9000;border-color: #FF9000" title="Bukti Kas" onclick="cetak_bukti_kas(0,{{$s->sppb_id}},{{$s->sppn_id}},2,0,0)"><i class="fa fa-money"></i></button>
                                    @php $a=0 @endphp
                                  @elseif($s->nomor_byr != null && $s->nomor_pnr == null)
                                    <button type="button" class="btn btn-warning btn-sm" style="background-color: #FF9000;border-color: #FF9000" title="Bukti Kas" onclick="cetak_bukti_kas({{$s->spp_id}},{{$s->sppb_id}},{{$s->sppn_id}},2,{{ json_encode($sppb_cetak_bukti_kas[$d]) }},0)"><i class="fa fa-money"></i></button>
                                    @php $a=0 @endphp
                                  @elseif($s->nomor_byr == null && $s->nomor_pnr != null)
                                 <button type="button" class="btn btn-warning btn-sm" style="background-color: #FF9000;border-color: #FF9000" title="Bukti Kas" onclick="cetak_bukti_kas({{$s->spp_id}},{{$s->sppb_id}},{{$s->sppn_id}},2,0,{{ json_encode($sppn_cetak_bukti_kas[$d]) }})"><i class="fa fa-money"></i></button>
                                    @php $a=0 @endphp
                                  @elseif($s->nomor_byr != null && $s->nomor_pnr != null)
                                  <button type="button" class="btn btn-primary btn-sm" style="background-color: #6E00FF; border-color:#6E00FF" title="Bukti Kas" onclick="cetak_bukti_kas({{$s->spp_id}},{{$s->sppb_id}},{{$s->sppn_id}},2,{{ json_encode($sppb_cetak_bukti_kas[$d]) }},{{ json_encode($sppn_cetak_bukti_kas[$d]) }})"><i class="fa fa-money"></i></button>                              
                                      @php $a=1 @endphp
                                  @endif
                                @endif
                  ...
                  <div class="tab-content">
                    ...
                    <button class="btn btn-primary" onclick="advanced_search(1)" style="margin-bottom: 15px">Advanced Search</button>
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @php $n=1 @endphp
                        @foreach($data as $d => $s)
                        @if($s->spp_status_proses < 13 && $s->spp_status_ob < 3 && $s->spp_status_ob != 2  && ($status_revisi[$d] == 'Revisi oleh' || $status_revisi[$d] == ''))
                          <tr>
                            ...
                            @if($s->spp_status_proses == 12 && ($sppb_cetak_bukti_kas[$d] != null || $sppn_cetak_bukti_kas[$d] != null))
                              ...
                              @elseif(isset($s->sppb_no) && isset($s->sppn_no))
                                @if($s->spp_status_bayar == 0 && $s->spp_status_terima == 0)
                                  <td><button type="button" class="btn btn-warning btn-sm" onclick="pembayaran({{$s->sppb_id}},{{$s->sppn_id}},2,0,0)">Belum Dibayar</button></td>
                                  @php $a=0 @endphp
                                @elseif($s->spp_status_bayar == 1 && $s->spp_status_terima == 0)
                                  <td><button type="button" class="btn btn-warning btn-sm" onclick="pembayaran({{$s->sppb_id}},{{$s->sppn_id}},2,{{ json_encode($sppb_bayar[$d]) }},0)">Belum Dibayar</button></td>
                                  @php $a=0 @endphp
                                @elseif($s->spp_status_bayar == 0 && $s->spp_status_terima == 1)
                                  <td><button type="button" class="btn btn-warning btn-sm" onclick="pembayaran({{$s->sppb_id}},{{$s->sppn_id}},2,0,{{ json_encode($sppn_terima[$d]) }})">Belum Dibayar</button></td>
                                  @php $a=0 @endphp
                            ...
                            @elseif($s->spp_status_proses == 12)
                              ...
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$s->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
                              <button type="button" class="btn btn-primary btn-sm" onclick="rekam_jejak({{ json_encode( $rekam_jejak[$d] )}})" title="Rekam Jejak" ><i class="fa fa-map-o"></i></button>
                              <button type="button" class="btn btn-primary btn-sm" onclick="window.open('{{ url('spp_keuangan/cetak_bukti_kas/'.$s->spp_id) }}').print();" title="Bukti Kas"><i class="fa fa-money"></i></button>
                              <button type="button" class="btn btn-info btn-sm" onclick="upload_dokumen_pendukung({{$s->spp_id}})" title="Upload Dokumen Tambahan" ><i class="fa fa-upload"></i></button>
                            @endif
                        ...
                        @if($s->spp_status_proses < 13 && $s->spp_status_ob == 2 && $status_revisi[$d] == 'Revisi oleh')
                          <tr>
                            ...
                            @if($s->spp_status_proses == 12)
                              @if(isset($s->sppb_no) && empty($s->sppn_no))
                                @if($s->spp_status_bayar == 0)
                                  <td><button type="button" class="btn btn-warning btn-sm" onclick="pembayaran({{$s->sppb_id}},0,0,{{ json_encode($sppb_bayar[$d]) }},0)">Belum Dibayar</button></td>
                                  @php $a=0 @endphp
                                @elseif($s->spp_status_bayar == 1)
                                  <td><button type="button" class="btn btn-success btn-sm" onclick="pembayaran({{$s->sppb_id}},0,0,{{ json_encode($sppb_bayar[$d]) }},0)">Sudah Dibayar</button></td>
                                  @php $a=1 @endphp
                              ...
                              @elseif(empty($s->sppb_no) && isset($s->sppn_no))
                                @if($s->spp_status_terima == 0)
                                  <td><button type="button" class="btn btn-warning btn-sm" onclick="pembayaran(0,{{$s->sppn_id}},1,0,{{ json_encode($sppn_terima[$d]) }})">Belum Dibayar</button></td>
                                  @php $a=0 @endphp
                                @elseif($s->spp_status_terima == 1)
                                  <td><button type="button" class="btn btn-success btn-sm" onclick="pembayaran(0,{{$s->sppn_id}},1,0,{{ json_encode($sppn_terima[$d]) }})">Sudah Dibayar</button></td>
                                  @php $a=1 @endphp
                      ...
                      <table class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        @foreach($data_selesai as $d => $s)
                          <tr>
                            ...
                            <td>Selesai</td>
                            @if(isset($s->sppb_no) && empty($s->sppn_no))
                            <td><button type="button" class="btn btn-success btn-sm" onclick="pembayaran({{$s->sppb_id}},0,0,{{ json_encode($sppb_bayar_selesai[$d]) }},0)">Sudah Dibayar</button></td>
                            @php $a=1 @endphp
                            @elseif(empty($s->sppb_no) && isset($s->sppn_no))
                            <td><button type="button" class="btn btn-success btn-sm" onclick="pembayaran(0,{{$s->sppn_id}},1,0,{{ json_encode($sppn_terima_selesai[$d]) }})">Sudah Dibayar</button></td>
                            @php $a=1 @endphp
                            @elseif(isset($s->sppb_no) && isset($s->sppn_no))
                            <td><button type="button" class="btn btn-success btn-sm" onclick="pembayaran({{$s->sppb_id}},{{$s->sppn_id}},2,{{ json_encode($sppb_bayar_selesai[$d]) }},{{ json_encode($sppn_terima_selesai[$d]) }})">Sudah Dibayar</button></td>                              
                            @php $a=1 @endphp
                            @endif
                            <td>
                              <button type="button" class="btn btn-info btn-sm" onclick="window.open('{{ url('spp_keuangan/detail/'.$s->spp_id) }}')" title="Detail" ><i class="fa fa-info"></i></button>
...
<div id="modal_advanced_search" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form action="{{route('advanced_search')}}" method="post" id="form_advanced_search" enctype="multipart\form-data">
      {{csrf_field()}}
        ...
        <div class="form-group" id="advanced_search_bagian">
            ...
            <select class="form-control" name="bagian">
              ...
              <option value="2">Keuangan & Akuntansi</option>
              @endforeach
            </select>
          </div>
          <div class="form-group" id="advanced_search_bagian">
...
<div id="modal_bukti_kas" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <form action="{{route('storebuktikas')}}" id="form_dokumen_tambahan" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="tab-content">
      <div class="tab-pane fade in" id="tab-pembayaran">
        ...
        {{csrf_field()}}
        <input type="hidden" id="form_a" name="form_a" value="">
        ...
        <div id="bayar_sppb">
          <div class="modal-body">
            <div class="form-group" hidden>
              ...
              <input type="text" class="form-control" id="nomor_bukti_kas_sppb" name="nomor_bukti_kas_sppb" maxlength="10" placeholder="nomor bukti kas pembayaran" value="-" >
            </div>
            <div class="form-group">
              <label>Tanggal Pembayaran :</label><br>
              <input type="text" class="form-control date" id="tanggal_bayar_sppb" name="tanggal_bayar_sppb" value="{{DATE('d-m-Y')}}" required>
            </div>
            <div class="form-group" hidden>
              <label>Kode Rekening :</label><br>
              <input type="text" class="form-control" value="-" id="rekening_sppb" onclick="kode_rekening_sppb()" placeholder="rekening pembayaran" >
      ...
      <div class="tab-pane fade in" id="tab-penerimaan">
        ...
        {{csrf_field()}}
        <input type="hidden" id="form_b" name="form_b" value="">
        <div id="bayar_sppn">
          <div class="modal-body">
          <input type="hidden" id="id_sppn_terima" name="id_sppn_terima">
            <div class="form-group" hidden>
              <label>Nomor Bukti Kas :</label><br>
              <input type="text" class="form-control" value="-" id="nomor_bukti_kas_sppn" name="nomor_bukti_kas_sppn" maxlength="10" placeholder="nomor bukti kas penerimaan" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group" hidden>
              <label>Kode Rekening :</label><br>
              <input type="text" class="form-control" value="-" id="rekening_sppn" onclick="kode_rekening_sppn()" placeholder="rekening penerimaan" >
        ...
        <div id="bayar_sppb_cbk">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="penerima_cbk" autocomplete="off" onclick="kode_penerima_sppb()" placeholder="Penerima" required>
              <input type="hidden" id="penerima_1_cbk" name="penerima"> 
            </div>
        ...
        <div id="bayar_sppn">
          ...
          <input type="hidden" id="id_sppn_terima_cbk" name="id_sppn_terima">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" autocomplete="off" id="diterima_dari_cbk" onclick="kode_diterima_dari_sppb()" placeholder=" Diterima Dari" required>
              <input type="hidden" id="diterima_dari_1_cbk" name="diterima_dari"> 
            </div>
    ...
    <div class="modal-content">
      ...
      {{csrf_field()}}
        ...
        <div class="form-group" id="pilih_file_spp" onclick="pilih_file()">
            ...
            <label class="fancy-radio">
              <input  name="upload_file" id="file_baru" value="file_baru" type="radio" required> 
      ...
      <form action="{{route('storedokumentambahan')}}" id="form_dokumen_tambahan" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <span style="color: red">*Format Gambar/PDF</span>
            <input type="file" class="file-multiple" name="dokumen_tambahan[]" accept="application/pdf, image/*"  multiple required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-success">Submit</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      {{csrf_field()}}
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success" id="submit_revisi" onclick="confirm_revisi()">Submit</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    if(index_cetak == 1){
      var url = 'spp_keuangan/cetak/'+id_cetak;
  ...
  function advanced_search(index,user){
    ...
    if (index == 1) {
      ...
      $('#advanced_search_rentang_waktu').show();
      $('#advanced_search_posisi_terkini').hide();
      $('#advanced_search_status_bayar1').remove();
      $('#advanced_search_status_bayar2').remove();
      $('#modal_advanced_search').modal('show');
    } else {
      $('#advanced_search_bagian').show();
      $('#advanced_search_rentang_waktu').show();
 ...
 $( ".cetakbuktikas" ).click(function() {
  var str = $(".cetakbuktikas").val();
   window.open('spp_keuangan/cetak_bukti_kas/'+ str);
});
  function edit_bayar_sppb(form){
    if(form == 0){
      var id = $("#id_sppb_bayar").val();
      $("#form").val(0);
      $("#form-bayar").attr('action', 'spp_keuangan/update_bayar/'+ id);
      ...
      $("#form-terima").attr('action', 'spp_keuangan/update_bayar/'+ id);
  ...
  function pembayaran(id_sppb,id_sppn,form,data_sppb,data_sppn){
    ...
    console.log(data_sppb.sppb_bayar_tanggal);
    ...
    if(data_sppb !== 0){
        ...
        $("#nomor_bukti_kas_sppb").attr('readonly','readonly');
    ...
    if(form == 0){
      ...
      $("#form-bayar").attr('action', 'spp_keuangan/bayar/'+ id_sppb);
      ...
      $("#modal_pembayaran").modal('show');
      $("#form-terima").attr('action', 'spp_keuangan/bayar/'+ id_sppn);
  ...
  function cetak_bukti_kas(id_spp,id_sppb,id_sppn,form,data_sppb,data_sppn){
    $("#form_a_cbk").val(form);
    $("#form_b_cbk").val(form);
    ...
    console.log($("#form").val());
      if(data_sppb !== 0){
          ...
          $("#penerima_cbk").val(data_sppb.master_vendor_nama_bank+' / '+data_sppb.master_vendor_alamat);
          $("#penerima_cbk").attr('disabled','disabled');
          $("#penerima_1_cbk").val(data_sppb.master_vendor_id);
        ...
        $("#penerima_cbk").val('');
        $("#penerima_cbk").attr('disabled',false);
        $("#penerima_1_cbk").val('');
      ...
      if(data_sppn !== 0){
          ...
          $("#diterima_dari_cbk").val(data_sppn.master_vendor_nama_bank+' / '+data_sppn.master_vendor_alamat);
          $("#diterima_dari_cbk").attr('disabled','disabled');
          $("#diterima_dari_1_cbk").val(data_sppn.master_vendor_id);
        ...
        $("#diterima_dari_cbk").attr('disabled',false);
        $("#diterima_dari_1_cbk").val('');
    ...
    if(form == 0){
      ...
      $( ".pisan" ).one( "click", function() {
          $(".pisan").hide();
          $("#form-bayar_cbk").attr('action', 'spp_keuangan/bukti_kas/'+ id_sppb);
      });
      ...
      $( ".pisan" ).one( "click", function() {
          $(".pisan").hide();
          $("#form-terima_cbk").attr('action', 'spp_keuangan/bukti_kas/'+ id_sppn);
      });
  ...
  function upload_kirim(id,file){
    ...
    if(file){
      ...
      document.getElementById("spp_kabag").removeAttribute("required");
        $("#form-kirim").attr('action', 'spp_keuangan/upload/'+ id);
  ...
  function bayar(sppb_id,sppn_id,status,b,n) {
		Swal.fire({
			title: '',
			showDenyButton: true,
			showCancelButton: false,
			confirmButtonText: `Pembayaran`,
			denyButtonText: `Penerimaan`,
      ...
      if(status == 0){
        ...
        $("#bayar_sppn").hide();
				$("#modal_pembayaran").modal('show');
        $("#form-bayar").attr('action', 'spp_keuangan/bayar/'+ sppb_id);
			  } else if (result.isDenied) {
        $("#form").val(1);
        $("#bayar_sppb").hide();
        $("#bayar_sppn").show();
				$("#modal_pembayaran").modal('show');
        $("#form-bayar").attr('action', 'spp_keuangan/bayar/'+ sppn_id);
			  }
      }
      else if(status == 1){
        if (result.isConfirmed) {
  ...
  function selesai(id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = `{{url('')}}/spp_keuangan/selesai/`+id;
        Swal.fire({
  ...
  function revisi(id,data){
    ...
    $("#form-revisi").attr('action', 'spp_keuangan/revisi/'+ id);
  }

  function confirm_revisi(){
    var bla = $('#keterangan_revisi').val();
    if (bla == '') {
      Swal.fire({
        icon: 'error',
  ...
  function batal(id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = `{{url('')}}/spp_keuangan/batal/`+id;
        Swal.fire({
          title: 'Hapus!',
          text: 'SPP Telah berhasil anda batalkan.',
          allowOutsideClick: false,
          icon: 'success',
          showConfirmButton: false,
          }
