...
@section('konten')
    ...
    <div class="main">
        ...
        <div class="main-content">
            <form action="{{ route('storespp') }}" target="" id="form_spp" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="panel" id="panel_sppb_sppn" style="display:none">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="referensi_spp" name="referensi" class="form-control"
                                    ...
                                    <div id="fp_spp">
                                        <div id="faktur_pajak_spp_1">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input maxlength="16" type="text" id="faktur_pajak_spp"
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="tab-informasi-sppb">
                                            ...
                                            <div class="form-group row" id="form_referensi_sppb">
                                                <label class="col-sm-2 col-form-label">Referensi</label>
                                                <div class="col-sm-10">
                                                    <input type="text" id="referensi_sppb" name="referensi_sppb"
                                            ...
                                            {{-- <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="au53_sppb" name="au53_sppb" class="form-control" placeholder="Nomor AU. 53 SPPb" autocomplete="off">
                                                </div>
                                            </div> --}}
                                            <div class="form-group row">
                                            ...
                                            <div id="fp_sppb">
                                                <div id="faktur_pajak_sppb_1">
                                                    <div class="form-group row" id="form_faktur_pajak_sppb">
                                                        <label class="col-sm-2 col-form-label">Faktur Pajak </label>
                                                        <div class="col-sm-4">
                                                            <input type="text" id="faktur_pajak_sppb" maxlength="16"
                                                    ...
                                                    <div class="form-group row" id="atas_nama_karyawan_kas_1">
                                                        ...
                                                        <div id="kas_karyawan_master">
                                                            ...
                                                            {{-- <div class="col-sm-2" id="btn_karyawan_kas_sppb_1">
                                                                <button type="button" class="btn btn-success btn-sm" onclick="tambah_karyawan_kas_sppb(1)">+</button>
                                                            </div> --}}
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" id="alamat_karyawan_kas_input_1">
                                                ...
                                                <div class="col-sm-5">
                                                        ...
                                                        <div id="nomor_vendor_sppb_1" style="display:none">
                                                            <div class="col-sm-9">
                                                                <div class="row-fluid" id="parent_kbb_sppb_1">
                                                                    <select class="selectpicker slct_sppb"
                                                                        data-live-search="true" data-dropup-auto="false"
                                                                        data-width="100%" id="sap_vendor_sppb_1"
                                                                        data-size="7" name="isi_sppb_vendor"
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="row-fluid" id="parent_kbb_sppb_1">
                                                                    <select class="selectpicker" data-live-search="true"
                                                                        data-dropup-auto="false" id="sap_gl_sppb_1"
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <div class="row-fluid" id="parent_kbb_sppb_1">
                                                                        <select class="selectpicker slct_sppb"
                                                                            ...
                                                                            id="sap_customer_sppb_1" data-size="7"
                                                                            name="isi_sppb_customer"
                                                                            onchange="pilih_rekening_sppb(1, 'sap_customer_sppb_')">
                                                                            <option disabled selected>---Pilih Kode
                                                                                Customer---</option>
                                                                            @foreach ($customer as $cs)
                                                                                <option
                                                                                    value="{{ $cs->master_customer_id }}">
                                                                                    {{ $cs->master_customer_kode_sap }}
                                                                                    ({{ $cs->master_customer_nama }})
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9" id="cost_center_sppb_1"
                                                            style="display: none">
                                                            <select class="form-control" id="select_cost_center_sppb_1"
                                                                name="isi_sppb[1][cost_center]">
                                                                <option value="" disabled selected>-- Pilih Cost
                                                                    Center --</option>
                                                                @foreach ($costcenter as $cost)
                                                                    <option value="{{ $cost->master_cost_center_id }}">
                                                                        {{ $cost->master_cost_center_kode }}
                                                                        {{ $cost->master_cost_center_keterangan }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-9" id="profit_center_sppb_1"
                                                            ...
                                                            <select class="form-control selectpicker"
                                                                ...
                                                                <option value="" disabled selected>-- Pilih Profit
                                                                    Center --</option>
                                                                @foreach ($profitcenter as $profit)
                                                                    <option
                                                                        value="{{ $profit->master_profit_center_id }}">
                                                            ...
                                                            <div class="col-sm-9">
                                                                @foreach ($cost_center_id as $ccid)
                                                                    ...
                                                                    <input type="hidden" name="isi_sppb[1][cost_center]"
                                                                        value="{{ $ccid->master_cost_center_id }}"
                                                                        readonly>
                                                                @endforeach
                                                            </div>
                                                        @elseif($bagian_karyawan->pemisah_keb_bag == 2)
                                                            ...
                                                            <div class="col-sm-9">
                                                                @foreach ($cost_center_id as $ccid)
                                                                    ...
                                                                    <input type="hidden"
                                                                        name = "isi_sppb[1][profit_center]"
                                                                        value="{{ $ccid->master_profit_center_id }}"
                                                                        readonly>
                                                                @endforeach
                                                            </div>
                                                        @endif --}}
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="tab-informasi-sppn">
                                            ...
                                            <div class="form-group row" id="form_referensi_sppn">
                                                <label class="col-sm-2 col-form-label">Referensi</label>
                                                <div class="col-sm-10">
                                                    <input type="text" id="referensi_sppn" name="referensi_sppn"
                                                    ...
                                                    <div class="form-group row" id="form_faktur_pajak_sppn">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" id="faktur_pajak_sppn_1"
                                                                maxlength="16" name="faktur_pajak_sppn[1][fp]"
                                                                class="form-control"
                                            ...
                                            {{-- <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control validate_sppn validate_spp_all"
                                                        id="metode_pembayaran_sppn" name="metode_pembayaran_sppn"
                                                        required>
                                            ...
                                            <div class="form-group row" style="display:none;"
                                                id="pilih_lampirkan_sppn" onclick="pilih_data_sppn()">
                                                <label class="col-sm-2 col-form-label"></label>
                                                <div class="col-sm-10">
                                                    <div class="col-sm-2">
                                                        <label class="fancy-radio">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label class="fancy-radio">
                                                            <input name="pilih_data_sppn" id="lampirkan_data_sppn"
                                                                value="lampirkan_data" type="radio"
                                                                checked="checked">
                                                            <span style="font-size:17px"><i></i>Data dilampirkan</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="form-group row" id="atas_nama_vendor_sppn">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" id="atas_nama_bank_sppn_vendor"
                                                            ...
                                                            placeholder="Atas Nama Bank SPPn" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Nama Bank *</label>
                                                ...
                                                <div class="form-group row" id="atas_nama_karyawan_bank_sppn">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="atas_nama_bank_sppn_karyawan_1"
                                                            onclick="bank_karyawan_sppn(1)"
                                                            name="karyawan_sppn[1][nama]" class="form-control"
                                                            placeholder="Atas Nama Bank SPPn" autocomplete="off">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="rekening_bank_sppn_karyawan_1"
                                                            name="karyawan_sppn[1][no_rek]"
                                                            onclick="bank_karyawan_sppn(1)" class="form-control"
                                                            placeholder="Nomor Rekening Bank SPPn" autocomplete="off">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-5">
                                                    {{-- <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="row-fluid" id="parent_kbb_sppn_1" >
                                                                <select class="selectpicker"  data-live-search="true" data-dropup-auto="false" id="kode_kbb_sppn_1" data-width="100%" name="isi_sppn[1][kode_kbb]" data-size="7" onchange="pilih_rekening_sppn(1,'sap_vendor_sppn_')">
                                                                    <option value="" disabled selected>---Pilih KBB---</option>
                                                                select>
                                                            </div>
                                                        </div>
                                                    </div> --}}
                                                    <div class="form-group row">
                                                        ...
                                                        <div id="nomor_vendor_sppn_1" style="display:none">
                                                            <div class="col-sm-9">
                                                                <div class="row-fluid" id="parent_kbb_sppn_1">
                                                                    <select class="selectpicker" data-live-search="true"
                                                                        data-dropup-auto="false" data-width="100%"
                                                                        id="sap_vendor_sppn_1" data-size="7"
                                                                        name="isi_sppn_rekening"
                                                        ...
                                                        <div id="nomor_gl_sppn_1" style="display:none">
                                                            <div class="col-sm-9">
                                                                <div class="row-fluid" id="parent_kbb_sppn_1">
                                                                    <select class="selectpicker" data-live-search="true"
                                                                        data-dropup-auto="false" id="sap_gl_sppn_1"
                                                                        data-size="7" data-width="100%"
                                                                        name="isi_sppn_gl"
                                                        ...
                                                        @if (in_array($bagianid, [124, 126, 127]))
                                                            <div id="nomor_customer_sppn_1" style="display:none">
                                                                <div class="col-sm-9">
                                                                    <div class="row-fluid" id="parent_kbb_sppn_1">
                                                                        <select class="selectpicker slct_sppn"
                                                                            data-live-search="true"
                                                                            data-dropup-auto="false" data-width="100%"
                                                                            id="sap_customer_sppn_1" data-size="7"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9" id="cost_center_sppn_1"
                                                            style="display: none">
                                                            <select class="form-control" id="select_cost_center_sppn_1"
                                                        ...
                                                        {{-- @if ($bagian_karyawan->pemisah_keb_bag == 1)
                                                            ...
                                                            <div class="col-sm-9">
                                                                @foreach ($cost_center_id as $ccid)
                                                                    ...
                                                                    <input type="hidden"
                                                                        name="isi_sppn[1][cost_center]"
                                                                        value="{{ $cost->master_cost_center_id }}"
                                                                        readonly>
                                                                @endforeach
                                                            </div>
                                                        @elseif($bagian_karyawan->pemisah_keb_bag == 2)
                            ...
                            <tbody>
                                {{-- @foreach ($gl as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" onclick="pilih_gl_sppb('{{$value->master_gl_id}}','{{$value->master_gl_kode}}', '{{$value->master_gl_keterangan}}')" title="Pilih" ><i class="fa fa-check"></i></button>
                                        </td>
                                    </tr>
                                @endforeach --}}
                            </tbody>
                            ...
                            <tbody>
                                {{-- @foreach ($gl as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value->master_gl_keterangan}}</td>
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" onclick="pilih_gl_sppn('{{$value->master_gl_id}}','{{$value->master_gl_kode}}', '{{$value->master_gl_keterangan}}')" title="Pilih" ><i class="fa fa-check"></i></button>
                                        </td>
                                    </tr>
                                @endforeach --}}
                            </tbody>
                            ...
                            <tbody>
                                ...
                                @foreach ($karyawan as $key => $value)
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <button type="button" class="btn btn-info btn-sm"
                                                onclick="pilih_karyawan_sppn('{{ $value->karyawan_id }}','{{ $value->karyawan_nama }}', '{{ $value->karyawan_nama_bank }}', '{{ $value->karyawan_no_rekening }}')"
                                                title="Pilih"><i class="fa fa-check"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <script type="text/javascript">
        ...
        function tambah_karyawan_kas_sppb(index) {
            index++;
            $('#kas_sppb_master').append(`<div class="form-group row" id="atas_nama_karyawan_kas_${index}">
													<label class="col-sm-2 col-form-label"></label>
													<div class="col-sm-8">
    ...
    // 									</div>`);
        ...
        function js_sppb(index) {
            ...
            if (pilihan == 'vendor') {
                ...
                $("#sap_vendor_sppn_" + index).attr("class", "selectpicker");
                $("#sap_customer_sppn_" + index).attr("class", "form-control");

                $("#sap_gl_sppb_" + index).attr('class', 'form-control');
                $('#sap_vendor_sppb_' + index).attr('class', 'selectpicker');
                ...
                $("#sap_gl_sppb_" + index).attr('class', 'selectpicker');
        ...
        function js_sppn(index) {
            ...
            if (pilihan == 'vendor') {
                ...
                console.log("ini GL");
                $('#sap_gl_sppn_' + index).attr("class", "selectpicker");
											...
											<div class="col-sm-5">
												...
												<div class="form-group row">
                                                    ...
                                                    <div id="nomor_vendor_sppb_${index_sppb}" style="display:none">
                                                        <div class="col-sm-9">
                                                            <div class="row-fluid" id="parent_kbb_sppb_${index_sppb}">
                                                                <select class="selectpicker slct_sppb" data-live-search="true" data-dropup-auto="false" data-width="100%" id="sap_vendor_sppb_${index_sppb}" data-size="7" name="isi_sppb[${index_sppb}][vendor]" onchange="pilih_rekening_sppb(${index_sppb},'sap_vendor_sppb_')">
                                                                    <option disabled selected>---Pilih SAP---</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="nomor_gl_sppb_${index_sppb}" style="display:none">
                                                        <div class="col-sm-9">
                                                            <div class="row-fluid" id="parent_kbb_sppb_${index_sppb}">
                                                                <select class="selectpicker" data-live-search="true" data-dropup-auto="false" id="sap_gl_sppb_${index_sppb}" data-size="7" data-width="100%" name="isi_sppb[${index_sppb}][gl]" onchange="pilih_rekening_sppb(${index_sppb},'sap_gl_sppb_')">
                                                    ...
                                                    ${bagianid === 124 || bagianid === 126 || bagianid === 127 ? `
                                                        <div id="nomor_customer_sppb_${index_sppb}" style="display:none">
                                                            <div class="col-sm-9">
                                                                <div class="row-fluid" id="parent_kbb_sppb_${index_sppb}">
                                                                    <select class="selectpicker slct_sppb" data-live-search="true" data-dropup-auto="false" data-width="100%" id="sap_customer_sppb_${index_sppb}" data-size="7" name="isi_sppb[${index_sppb}][customer]" onchange="pilih_rekening_sppb(${index_sppb}, 'sap_customer_sppb_')">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9" id="profit_center_sppb_${index_sppb}" style="display: none">
														<select class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" id="select_profit_center_sppb_${index_sppb}" name="isi_sppb[${index_sppb}][profit_center]">
															<option value="" disabled selected>-- Pilih Cost Center --</option>
															@foreach ($profitcenter as $profit)
											...
											<div class="col-sm-5">
												...
												<div class="form-group row">
                                                    ...
                                                    <div id="nomor_vendor_sppn_${index_sppn}" style="display:none">
                                                        <div class="col-sm-9">
                                                            <div class="row-fluid" id="parent_kbb_sppn_${index_sppn}">
                                                                <select class="selectpicker slct_sppn" data-live-search="true" data-dropup-auto="false" data-width="100%" id="sap_vendor_sppn_${index_sppn}" data-size="7" name="isi_sppn[${index_sppn}][vendor]" onchange="pilih_rekening_sppn(${index_sppn},'sap_vendor_sppn_')">
                                                                    <option disabled selected>---Pilih SAP---</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="nomor_gl_sppn_${index_sppn}" style="display:none">
                                                        <div class="col-sm-9">
                                                            <div class="row-fluid" id="parent_kbb_sppn_${index_sppn}">
                                                                <select class="selectpicker" data-live-search="true" data-dropup-auto="false" id="sap_gl_sppn_${index_sppn}" data-size="7" data-width="100%" name="isi_sppn[${index_sppn}][gl]" onchange="pilih_rekening_sppn(${index_sppn},'sap_gl_sppn_')">
                                                                    <option value="" disabled selected>-- Pilih Kode GL --</option>
                                                                    @foreach ($gl as $r)
                                                                    <option value="{{ $r->master_gl_id }}" data-budget_${index_sppn}="{{ $r->jumlah_budget }}" data-budget_${index_sppn}="{{ $r->master_gl_id }}">{{ $r->master_gl_kode }} ({{ $r->master_gl_keterangan }})</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <label class="col-sm-3 col-form-label">RKAP</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control budget_gl_${index_sppn} nominal" placeholder="Budget" autocomplete="off" readonly>
                                                            <input type="hidden" class="budget_gl_hide_${index_sppn}" name="budget">
                                                        </div>
                                                        <label class="col-sm-12 col-form-label mt-2"></label>
                                                        <label class="col-sm-3 col-form-label">Realisasi</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control realisasi_${index_sppn} nominal" placeholder="Realisasi" autocomplete="off" readonly>
                                                            <input type="hidden" class="budget_gl_hide" name="budget">
                                                        </div>
                                                        <label class="col-sm-12 col-form-label mt-2"></label>
                                                        <label class="col-sm-3 col-form-label">On Process</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control onproses_${index_sppn} nominal" placeholder="Onproses" autocomplete="off" readonly>
                                                            <input type="hidden" class="budget_gl_hide" name="budget">
                                                        </div>
                                                        <label class="col-sm-12 col-form-label mt-2"></label>
                                                        <label class="col-sm-3 col-form-label">Sisa</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control sisa_${index_sppn} nominal" placeholder="Sisa" autocomplete="off" readonly>
                                                            <input type="hidden" class="budget_gl_hide" name="budget">
                                                        </div>
                                                        <div class="col-sm-9">
                                                    ...
                                                    ${bagianid === 124 || bagianid === 126 || bagianid === 127 ? `
                                                                                                                                                                            <div id="nomor_customer_sppn_${index_sppn}" style="display:none">
                                                                                                                                                                                <div class="col-sm-9">
                                                                                                                                                                                    <div class="row-fluid" id="parent_kbb_sppn_${index_sppn}">
                                                                                                                                                                                        <select class="selectpicker slct_sppn" data-live-search="true" data-dropup-auto="false" data-width="100%" id="sap_customer_sppn_${index_sppn}" data-size="7" name="isi_sppn[${index_sppn}][customer]" onchange="pilih_rekening_sppn(${index_sppn}, 'sap_customer_sppn_')">
                                                                                                                                                                                            <option disabled selected>-- Pilih Kode Customer --</option>
                                                                                                                                                                                                ${customer.map(cs => `<option value="${cs.master_customer_id}">${cs.master_customer_kode_sap} (${cs.master_customer_nama})</option>`).join('')}
                                                                                                                                                                                        </select>
                                                                                                                                                                                    </div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9" id="profit_center_sppn_${index_sppn}" style="display: none">
														<select class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" id="select_profit_center_sppn_${index_sppn}" name="isi_sppn[${index_sppn}][profit_center]">
        ...
        function tambah_faktur_pajak_spp(index) {
            ...
            $('#fp_spp').append(`<div id="faktur_pajak_spp_${index}">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label"></label>
										<div class="col-sm-4">
											<input type="text" id="faktur_pajak_spp" maxlength="16" name="faktur_pajak_spp[${index}][fp]" class="form-control validate_spp_all" placeholder="Faktur Pajak ${index}" autocomplete="off">
										</div>
										<label class="col-sm-1">Tanggal Faktur Pajak</label>
											<div class="col-sm-3">
        ...
        function tambah_faktur_pajak_sppb(index) {
            ...
            $('#fp_sppb').append(`<div id="faktur_pajak_sppb_${index}">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label"></label>
										<div class="col-sm-4">
											<input type="text" id="faktur_pajak_spp" maxlength="16" name="faktur_pajak_sppb[${index}][fp]" class="form-control validate_spp_all" placeholder="Nomor Faktur Pajak SPPb ${index}" autocomplete="off">
										</div>
										<label class="col-sm-1">Tanggal Faktur Pajak</label>
											<div class="col-sm-3">
        ...
        function tambah_faktur_pajak_sppn(index) {
            ...
            $('#fp_sppn').append(`<div id="faktur_pajak_sppn_${index}">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label"></label>
										<div class="col-sm-4">
											<input type="text" id="faktur_pajak_spp" maxlength="16" name="faktur_pajak_sppn[${index}][fp]" class="form-control validate_spp_all" placeholder="Nomor Faktur Pajak SPPn ${index}" autocomplete="off">
										</div>
										<label class="col-sm-1">Tanggal Faktur Pajak</label>
											<div class="col-sm-3">
