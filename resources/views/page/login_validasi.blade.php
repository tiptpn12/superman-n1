                ...
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                ...
                                <div class="logo text-center"><img src="{{ asset('assets/img/LOGO-PTPN-I.png') }}"
                                        alt="Klorofil Logo" style="height:60px;"></div>
                            ...
                            @endif
                            <form class="form-auth-small" action="{{ route('loginvalidasipost', ['id' => $id]) }}"
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            ...
                            <h1>di Aplikasi Monitoring SPP<br> PT Perkebunan Nusantara I</h1>
                        </div>
                    </div>
