...
@section('konten')
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">Rekening</h3>
                <div class="row">
                    <div class="col-md-12">
                        <!-- TABLE -->
                        <div class="panel">
                      ...
                      <tr>
                        ...
                        <td>{{ $value->master_rekening_status == 1 ? "Aktif" : "Tidak Aktif" }}</td>
                        <td>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" onclick="hapus({{ $value->master_rekening_id }}, {{ $value->master_rekening_status }})" title="Hapus Data" ><i class="fa fa-trash-o" aria-hidden="true"></i> Ubah Status</button>
                        </td>
                      </tr>
                    @endforeach --}}
                                    </tbody>
            ...
            <div class="modal-content">
                <form action="{{ url('') }}/rekening/store" method="post">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Modal Tambah Data Rekening</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Kode KBB</label>
                            <input type="text" id="tambah_kode_kbb" name="kode_kbb" class="form-control"
                                placeholder="Kode KBB" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Kode SAP</label>
                            <input type="number" id="tambah_kode_sap" name="kode_sap" class="form-control"
    ...
    <div id="modal_ubah" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <form action="{{ url('') }}/rekening/update" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" id="ubah_id" name="id">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Modal Ubah Data Rekening</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Kode KBB</label>
                            <input type="text" id="ubah_kode_kbb" name="kode_kbb" class="form-control"
                                placeholder="Kode KBB" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Kode SAP</label>
                            <input type="number" id="ubah_kode_sap" name="kode_sap" class="form-control"
                                placeholder="Kode SAP" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
    ...
    <div id="modal_import" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <form action="{{ route('rekening.import') }}" id="form_upload_excel" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Upload Data Rekening</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group" id="upload_data">
                            <label>Upload data Rekening:</label><br>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            tabel = $('#table').DataTable({
                ...
                columns: [{
                    ...
                    // { data: 'company_nama', name: 'company_nama' },
                    {
                        data: 'master_rekening_status',
                        name: 'master_rekening_status',
                    ...
                    <button type="button" class="btn btn-danger btn-sm" onclick="hapus(${full.master_rekening_id}, '${full.master_rekening_status}')" title="Hapus Data"><i class="fa fa-trash-o" aria-hidden="true"></i> Ubah Status</button>
                `;
                        }
                    }
                ]
        ...
        function ubah(data) {
            $("#ubah_id").val(data.master_rekening_id);
            $("#ubah_kode_kbb").val(data.master_rekening_kode_kbb);
            $("#ubah_kode_sap").val(data.master_rekening_kode_sap);
            $("#ubah_keterangan").val(data.master_rekening_keterangan);
        ...
        function hapus(id, status) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `{{ url('') }}/rekening/destroy/${id}/${status}`;
                }
            })
        }
    </script>
