...
class SppdController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($flow,$company);
        //dump($flow,$grup_id,$level,$akses,$petugas_pp,$company,$bagian,$grup_flow);
        // dd($flow);
        ...
        // dd(json_decode($spp_terlewati));
        // dd(json_decode($spp_terlewati));
        // dd(json_decode($master_flow),$akses);
        // $urutan = 3;
        // foreach($flowsppd as $key => $g){
        //         if($urutan == $key){
        //             echo $key.'bener'.$g ;
        //         }
        ...
        // dd($grup_id);
        //GRUP UI = 1 (OPERATOR) DAN AKSES (PEMBUAT SPP))))))))))))
        // operator
        if ($grup_id == 1 || $akses == 18) {
            $data = DB::table('spp')
            ...
            $data_batal_admi = DB::table('spp')->where('spp.master_bagian_id', '=', $bagian)
                // ->where('spp.master_bagian_id','=',$bagian)
                // ->where('spp.sppd_proses','>=',$spp_terlewati)
                ->where('spp.sppd_status', 4)
                ->whereIn('spp.flow_id', $flow)
                ...
                ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
                ->select('spp_no_dokumen', 'spp_id', 'flow_id', 'spp.sppb_id', 'sppd_proses', 'sppd_posisi', 'sppd_revisi', 'sppd_status', 'spp.sppn_id', 'spp_kabag', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"))
                ->groupBy('spp_id', 'tanggal')
                ->orderBy('spp_tanggal', 'desc')
                ->get();

            $data_selesai = DB::table('spp')
                ->where('spp.master_bagian_id', '=', $bagian)
                // ->where('spp.sppd_proses','>=',$spp_terlewati)
                ->where('spp.sppd_status', 100)
                ->whereIn('spp.flow_id', $flow)
                ...
                ->get();
            //dd($data_selesai);
            $to_do_list = DB::table('spp')->where('spp.master_bagian_id', '=', $bagian)
                ->where('spp.sppd_posisi', $akses)
                ...
                ->orderBy('spp_tanggal', 'desc')
                ->get();
            // foreach ($to_do_list as $v)
            // {
            //     $posisi_dinamis_to_do_list[] = DB::table('master_hak_akses')->where('master_hak_akses.master_hak_akses_id', '=', $v->sppd_posisi)
            //         ->select('master_hak_akses.*')->first();
            // }
            $counttodolist = $to_do_list->count();
            // dd($counttodolist);
            $revisi = DB::table('spp')->where('spp.master_bagian_id', '=', $bagian)
            ...
            // foreach ($revisi as $v)
            // {
            //     $posisi_dinamis_revisi[] = DB::table('master_hak_akses')->where('master_hak_akses.master_hak_akses_id', '=', $v->sppd_posisi)
            //         ->select('master_hak_akses.*')->first();
            // }
            $countrevisi = $revisi->count();
            // dd($countrevisi);
        }
        //GRUP UI=2 KIRIM TERIMA
        else if ($grup_id == 2) {
            //petugas PP
            //dump($company, $akses, $flow, $petugas_pp);
            if ($petugas_pp == 1) {
                //$spp = Spp::All();
                ...
                //}
                //dump($users[0]->flow_akses,$users);

                // foreach ($master_flow as $key => $g)
                // {
                //     if ($akses == $g->flow_detail_urutan)
                //     {
                //         $spp_terlewati = $key;
                //     }
                // }
                ...
                $data = DB::table('spp')
                    ...
                    ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
                    ->leftJoin('master_hak_akses', 'master_hak_akses.master_hak_akses_id', '=', 'spp.sppd_posisi')
                    ->select('master_hak_akses_nama', 'spp_no_dokumen', 'spp_id', 'flow_id', 'spp.sppb_id', 'sppd_proses', 'sppd_posisi', 'sppd_revisi', 'sppd_status', 'spp.sppn_id', 'spp_kabag', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"))
                    ->groupBy('spp_id', 'tanggal')
                    ->orderBy('spp_tanggal', 'desc')
                    ->get();
                // dd($data);
                ...
                //     $posisi_dinamis[] = DB::table('master_hak_akses')->where('master_hak_akses.master_hak_akses_id', '=', $v->sppd_posisi)
                //         ->select('master_hak_akses.*')->first();
                //     // $spp_revisi = DB::table('spp_revisi')->where('spp_id', '=', $v->spp_id)
                //     //     ->select('spp_revisi_keterangan')->first();
                // }
                // dd($$spp_revisi);
                $to_do_list = DB::table('spp')
                    ->where('spp.sppd_posisi', $akses)
                    ->where('spp.company_id', $company)
            ...
            //User bagian hak aksesnya kirim terima (kasubdiv dan kadiv)
            else {
                // $spp = Spp::All();
                ...
                // }
                // dd($spp_terlewati);
                $users = DB::table('master_flow_detail')->where('flow_detail_urutan', '=', $akses)->get();
                //dump($flow);
                $data = [];
                $data = DB::table('spp')
                    ->where('spp.master_bagian_id', '=', $bagian)
        ...
        //asisten kas bank
            ...
            $data = DB::table('spp')
                ...
                ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
                ->leftJoin('master_hak_akses', 'master_hak_akses.master_hak_akses_id', '=', 'spp.sppd_posisi')
                ->select('master_hak_akses_nama', 'sppb_bukti_kas.sppb_bukti_kas_id', 'spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'sppd_posisi', 'sppd_proses', 'spp.sppn_id', 'spp_status_terima', 'spp_status_bayar', 'master_bagian_nama', 'spp_status_proses', 'sppd_revisi', 'sppd_status', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppb_bukti_kas.master_rekening_id AS nomor_byr', 'sppn_bukti_kas.master_rekening_id AS nomor_pnr', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"), 'sppb.sppb_metode_pembayaran as metode_pembayaran')
                ->groupBy('spp_id', 'spp_status_proses', 'spp_status_posisi', 'tanggal', 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status')
                ->orderBy('spp_tanggal', 'desc')
                ->get();
            $to_do_list = DB::table('spp')
                ->where('spp.sppd_posisi', $akses)
            ...
            $revisi = DB::table('spp')
                ...
                ->leftJoin('sppn_bukti_kas', 'sppn.sppn_id', '=', 'sppn_bukti_kas.sppn_id')
                ->leftJoin('master_hak_akses', 'master_hak_akses.master_hak_akses_id', '=', 'spp.sppd_posisi')
                ->select('master_hak_akses_nama', 'spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'spp.sppn_id', 'sppd_revisi', 'sppd_status', 'sppd_posisi', 'sppd_proses', 'spp_kabag', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"), 'sppb_bukti_kas.master_rekening_id AS nomor_byr', 'sppn_bukti_kas.master_rekening_id AS nomor_pnr', 'sppb.sppb_metode_pembayaran as metode_pembayaran')
                ->groupBy('spp_id', 'tanggal')
                ->orderBy('spp_tanggal', 'desc')
                ->get();
            // dd($revisi);
            ...
            if ($data == null) {
                ...
                // }
                foreach ($to_do_list as $v) {
                    $sppb_cetak_bukti_kas_to_do_list[] = DB::table('sppb_bukti_kas')->where('sppb_bukti_kas.sppb_id', '=', $v->sppb_id)
                        ->leftJoin('master_gl', 'sppb_bukti_kas.master_rekening_id', '=', 'master_gl.master_gl_id')
                        ->select('master_gl.*', 'sppb_bukti_kas.*')->first();
                    $sppn_cetak_bukti_kas_to_do_list[] = DB::table('sppn_bukti_kas')->where('sppn_bukti_kas.sppn_id', '=', $v->sppn_id)
                        ->leftJoin('master_gl', 'sppn_bukti_kas.master_rekening_id', '=', 'master_gl.master_gl_id')
                        ->select('master_gl.*', 'sppn_bukti_kas.*')->first();
                }
                foreach ($revisi as $v) {
                    $sppb_cetak_bukti_kas_revisi[] = DB::table('sppb_bukti_kas')->where('sppb_bukti_kas.sppb_id', '=', $v->sppb_id)
                        ->leftJoin('master_gl', 'sppb_bukti_kas.master_rekening_id', '=', 'master_gl.master_gl_id')
                        ->select('master_gl.*', 'sppb_bukti_kas.*')->first();
                    $sppn_cetak_bukti_kas_revisi[] = DB::table('sppn_bukti_kas')->where('sppn_bukti_kas.sppn_id', '=', $v->sppn_id)
                        ->leftJoin('master_gl', 'sppn_bukti_kas.master_rekening_id', '=', 'master_gl.master_gl_id')
                        ->select('master_gl.*', 'sppn_bukti_kas.*')->first();
                }
                // foreach ($data as $v) {
                ...
                // }
                foreach ($to_do_list as $v) {
                    $datapenerima_to_do_list[] = DB::table('nama_karyawan')->where('nama_karyawan.sppb_id', '=', $v->sppb_id)
                        ->select('nama_karyawan.*')->first();
                    $data_diterima_dari_to_do_list[] = DB::table('nama_karyawan')->where('nama_karyawan.sppn_id', '=', $v->sppn_id)
                        ->select('nama_karyawan.*')->first();
                }
                foreach ($revisi as $v) {
                    $datapenerima_revisi[] = DB::table('nama_karyawan')->where('nama_karyawan.sppb_id', '=', $v->sppb_id)
                        ->select('nama_karyawan.*')->first();
                    $data_diterima_dari_revisi[] = DB::table('nama_karyawan')->where('nama_karyawan.sppn_id', '=', $v->sppn_id)
                        ->select('nama_karyawan.*')->first();
                }
            }
            $data_selesai = DB::table('spp')
            ...
            $data = DB::table('spp')
                ...
                ->leftJoin('sppn_bukti_kas', 'sppn.sppn_id', '=', 'sppn_bukti_kas.sppn_id')
                ->leftJoin('master_hak_akses', 'master_hak_akses.master_hak_akses_id', '=', 'spp.sppd_posisi')
                ->select('master_hak_akses_nama', 'sppb_bukti_kas.sppb_bukti_kas_id', 'spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'sppd_posisi', 'sppd_proses', 'spp.sppn_id', 'spp_status_terima', 'spp_status_bayar', 'master_bagian_nama', 'spp_status_proses', 'sppd_revisi', 'sppd_status', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppb_bukti_kas.master_rekening_id AS nomor_byr', 'sppn_bukti_kas.master_rekening_id AS nomor_pnr', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"), 'sppb.sppb_metode_pembayaran as metode_pembayaran', 'spp_bukti_kas_bank')
                ->groupBy('spp_id', 'tanggal')
                ->orderBy('spp_tanggal', 'desc')
                ->get();
            ...
            $revisi = DB::table('spp')
                ...
                ->leftJoin('sppn_bukti_kas', 'sppn.sppn_id', '=', 'sppn_bukti_kas.sppn_id')
                ->leftJoin('master_hak_akses', 'master_hak_akses.master_hak_akses_id', '=', 'spp.sppd_posisi')
                ->select('master_hak_akses_nama', 'spp_bukti_kas_bank', 'sppb_bukti_kas.sppb_bukti_kas_id', 'spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'sppd_posisi', 'sppd_proses', 'spp.sppn_id', 'spp_status_terima', 'spp_status_bayar', 'master_bagian_nama', 'spp_status_proses', 'sppd_revisi', 'sppd_status', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppb_bukti_kas.master_rekening_id AS nomor_byr', 'sppn_bukti_kas.master_rekening_id AS nomor_pnr', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"), 'sppb.sppb_metode_pembayaran as metode_pembayaran')
                ->groupBy('spp_id', 'tanggal')
                ->orderBy('spp_tanggal', 'desc')
                ->get();
            $countrevisi = $revisi->count();
            ...
            // }
            foreach ($to_do_list as $v) {
                $sppb_bayar_to_do_list[] = DB::table('sppb_bayar')->where('sppb_bayar.sppb_id', '=', $v->sppb_id)
                    ->select('sppb_bayar.*')->first();
                $sppn_terima_to_do_list[] = DB::table('sppn_terima')->where('sppn_terima.sppn_id', '=', $v->sppn_id)
                    ->select('sppn_terima.*')->first();
            }
            // foreach ($revisi as $v) {
            //     $sppb_bayar_revisi[] = DB::table('sppb_bayar')->where('sppb_bayar.sppb_id', '=', $v->sppb_id)
            //         ->select('sppb_bayar.*')->first();
            //     $sppn_terima_revisi[] = DB::table('sppn_terima')->where('sppn_terima.sppn_id', '=', $v->sppn_id)
            //         ->select('sppn_terima.*')->first();
            // }
            // foreach ($data as $v) {
            //     $sppb_cetak_bukti_kas[] = DB::table('sppb_bukti_kas')->where('sppb_bukti_kas.sppb_id', '=', $v->sppb_id)
        ...
        //         ->leftJoin('sppn_isi', 'sppn.sppn_id', '=', 'sppn_isi.sppn_id')->leftJoin('sppn_uraian', 'sppn_isi.sppn_isi_id', '=', 'sppn_uraian.sppn_isi_id')
        //         ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
        //         ->select('spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'sppd_proses', 'spp.sppn_id', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"))
        //         ->groupBy('spp_id', 'spp_status_proses', 'spp_status_posisi', 'tanggal', 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status')
        //         ->orderBy('spp_tanggal', 'desc')
        //         ->get();
        ...
        //         ->leftJoin('sppn_isi', 'sppn.sppn_id', '=', 'sppn_isi.sppn_id')->leftJoin('sppn_uraian', 'sppn_isi.sppn_isi_id', '=', 'sppn_uraian.sppn_isi_id')
        //         ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
        //         ->select('spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'spp.sppn_id', 'sppd_proses', 'spp_status_lunas', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', 'spp_status_bayar', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"))
        //         ->groupBy('spp_id', 'spp_status_proses', 'spp_status_posisi', 'spp_status_bayar', 'tanggal', 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status')
        //         ->orderBy('spp_tanggal', 'desc')
        //         ->get();
        // } else if ($level == 88 && $bagian == 2) {
        //     $data = [];
        ...
        //         ->leftJoin('sppn_isi', 'sppn.sppn_id', '=', 'sppn_isi.sppn_id')->leftJoin('sppn_uraian', 'sppn_isi.sppn_isi_id', '=', 'sppn_uraian.sppn_isi_id')
        //         ->leftJoin('master_bagian', 'spp.master_bagian_id', '=', 'master_bagian.master_bagian_id')
        //         ->select('spp_no_dokumen', 'spp_id', 'spp.sppb_id', 'sppd_proses', 'spp.sppn_id', 'spp_status_lunas', 'master_bagian_nama', 'spp_status_proses', 'spp_status_posisi', DB::raw("DATE_FORMAT(spp.spp_tanggal,'%d-%m-%Y') as tanggal"), 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status', DB::raw("GROUP_CONCAT(DISTINCT sppb_uraian_uraian SEPARATOR ',') as sppb_uraian2"), DB::raw("GROUP_CONCAT(DISTINCT sppn_uraian_uraian SEPARATOR ',') as sppn_uraian2"))
        //         ->groupBy('spp_id', 'spp_status_proses', 'spp_status_posisi', 'spp_status_bayar', 'tanggal', 'sppb_no', 'sppb_tanggal', 'sppb_total', 'sppn_no', 'sppn_tanggal', 'sppn_jumlah', 'sppd_status')
        //         ->orderBy('spp_tanggal', 'desc')
        //         ->get();
        // }
        ...
        //  }
        // foreach ($to_do_list as $d => $v) {
        //     $status_to_do_list[] = DB::table('rekam_jejak')->where('rekam_jejak.spp_id', '=', $v->spp_id)->select('spp_id', 'master_user_id', 'rekam_jejak_revisi', 'created_at')->latest('created_at')->first();
        //     $rekam_jejak_to_do_list[] = DB::table('rekam_jejak')->where('spp_id', '=', $v->spp_id)
        //         ->leftjoin('master_hak_akses AS asal', 'master_user_id', '=', 'asal.master_hak_akses_id')
        //         ->leftjoin('master_hak_akses AS tujuan', 'master_user_id_tujuan', '=', 'tujuan.master_hak_akses_id')
        //         ->select('rekam_jejak.*', 'asal.master_hak_akses_keterangan as asal', 'tujuan.master_hak_akses_keterangan as tujuan')
        //         ->groupBy('rekam_jejak_waktu')->orderBy('rekam_jejak_waktu', 'asc')->get();
        //     $posisi_to_do_list[] = DB::table('master_hak_akses')->where('master_hak_akses_id', '=', $v->spp_status_posisi)->select('master_hak_akses_keterangan')->first();
        //     // $posisi_batal[] = DB::table('rekam_jejak')->where('spp_id','=',$v->spp_id)->where('rekam_jejak_status','=',5)
        //     //                     ->join('master_hak_akses','master_user_id','=','master_hak_akses.master_hak_akses_id')
        //     //                     ->select('rekam_jejak.*','master_hak_akses.*')->first();
        //     $posisi_batal_to_do_list[] = DB::table('rekam_jejak')->where('spp_id', '=', $v->spp_id)
        //         ->join('master_hak_akses', 'master_user_id', '=', 'master_hak_akses.master_hak_akses_id')
        //         ->select('rekam_jejak.*', 'master_hak_akses.*')->first();
        //     // if($v->sppd_status == 3){
        //     //     $data_selesai[] = $v;
        ...
        // }
        // foreach ($revisi as $d => $v) {
        //     $status_revisi[] = DB::table('rekam_jejak')->where('rekam_jejak.spp_id', '=', $v->spp_id)->select('spp_id', 'master_user_id', 'rekam_jejak_revisi', 'created_at')->latest('created_at')->first();
        //     $rekam_jejak_revisi[] = DB::table('rekam_jejak')->where('spp_id', '=', $v->spp_id)
        //         ->leftjoin('master_hak_akses AS asal', 'master_user_id', '=', 'asal.master_hak_akses_id')
        //         ->leftjoin('master_hak_akses AS tujuan', 'master_user_id_tujuan', '=', 'tujuan.master_hak_akses_id')
        //         ->select('rekam_jejak.*', 'asal.master_hak_akses_keterangan as asal', 'tujuan.master_hak_akses_keterangan as tujuan')
        //         ->groupBy('rekam_jejak_waktu')->orderBy('rekam_jejak_waktu', 'asc')->get();
        //     $posisi_revisi[] = DB::table('master_hak_akses')->where('master_hak_akses_id', '=', $v->spp_status_posisi)->select('master_hak_akses_keterangan')->first();
        //     // $posisi_batal[] = DB::table('rekam_jejak')->where('spp_id','=',$v->spp_id)->where('rekam_jejak_status','=',5)
        //     //                     ->join('master_hak_akses','master_user_id','=','master_hak_akses.master_hak_akses_id')
        //     //                     ->select('rekam_jejak.*','master_hak_akses.*')->first();
        //     $posisi_batal_revisi[] = DB::table('rekam_jejak')->where('spp_id', '=', $v->spp_id)
        //         ->join('master_hak_akses', 'master_user_id', '=', 'master_hak_akses.master_hak_akses_id')
        //         ->select('rekam_jejak.*', 'master_hak_akses.*')->first();
        //     // if($v->sppd_status == 3){
        //     //     $data_selesai[] = $v;
        ...
        return view('page.spp.sppd', compact('data_batal_admi', 'sppn_terima_revisi', 'sppn_terima_to_do_list', 'sppb_bayar_revisi', 'sppb_bayar_to_do_list', 'data_diterima_dari_revisi', 'data_diterima_dari_to_do_list', 'datapenerima_revisi', 'datapenerima_to_do_list', 'sppn_cetak_bukti_kas_to_do_list', 'sppb_cetak_bukti_kas_to_do_list', 'sppb_cetak_bukti_kas_revisi', 'sppn_cetak_bukti_kas_revisi', 'posisi_batal_to_do_list', 'posisi_to_do_list', 'rekam_jejak_to_do_list', 'status_to_do_list', 'posisi_batal_revisi', 'posisi_revisi', 'rekam_jejak_revisi', 'status_revisi', 'posisi_dinamis_to_do_list', 'posisi_dinamis_revisi', 'stopper', 'countrevisi', 'counttodolist', 'to_do_list', 'revisi', 'id_cetak', 'index_cetak', 'vendor', 'index', 'data_selesai', 'data_batal', 'rekam_jejak_batal', 'data_selesai', 'spp_revisi', 'rekam_jejak_selesai', 'posisi_dinamis', 'datapenerima', 'data_diterima_dari', 'sppb_bayar_selesai', 'sppb_cetak_bukti_kas', 'sppn_cetak_bukti_kas', 'sppn_terima_selesai', 'data', 'posisi', 'status', 'status_revisi', 'rekam_jejak', 'sppb_bayar', 'sppn_terima', 'posisi_batal', 'b', 'bagian_id', 'rekening', 'gl'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //FORM SPPN SAJA
            ...
            try {
                ...
                $nomor = $kodebagian . "/SPPn/" . $urutansppn . "/" . $tahun;
        ...
        if ($idsppb != null) {
            ...
            if ($cek_sap != NULL) {
                $sppbisi = DB::table('sppb_isi')->where('sppb_isi.sppb_id', '=', $datasppb->sppb_id)
                    ...
                    ->leftJoin('master_profit_center', 'sppb_isi.master_profit_center_id', '=', 'master_profit_center.master_profit_center_id')
                    ->leftJoin('master_cash_flow', 'sppb_isi.master_cash_flow_id', '=', 'master_cash_flow.master_cash_flow_id')
                    ->select('sppb_isi.*', 'sppb_uraian.*', 'master_rekening.*', 'master_cost_center.*', 'master_profit_center.*', 'master_cash_flow.*', 'master_gl.*', 'master_customer.*')->get();
