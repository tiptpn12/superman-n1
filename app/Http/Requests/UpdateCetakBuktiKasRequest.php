...
class UpdateCetakBuktiKasRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ubah_sub_bagian_pembuat' => 'required',
            'ubah_nama_pembuat' => 'nullable',
            'ubah_sub_bagian_pemeriksa' => 'required',
            'ubah_nama_pemeriksa' => 'required',
            'ubah_bagian_pemeriksa' => 'required',
            'ubah_nama_bagian_pemeriksa' => 'required',
            'ubah_yang_menyetujui' => 'required',
            'ubah_nama_yang_menyetujui' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'ubah_sub_bagian_pembuat.required' => 'Field Tidak Boleh Kosong',
