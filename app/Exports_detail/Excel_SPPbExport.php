...
class Excel_SPPbExport implements FromView, ShouldAutoSize, WithTitle
{
    /**
     * @return \Illuminate\Support\Collection
     */
    protected $rentang_waktu, $status_bayar, $jenis_spp;
    ...
    public function view(): View
    {
            ...
            foreach ($spp as $s) {
                $datanya[] = DB::table('spp')->where('spp.spp_id', '=', $s->spp_id)
                    ...
                    ->select(
                        ...
                        'sppb_uraian_nominal  as sppb_nominal_satuan',
        ...
        // dd($data,$datanya);
        return view('page.laporan.laporan_excel_sppb', compact('totalNominalSppb', 'data', 'sppbisi', 'sppb_bayar', 'rentang_waktu', 'karyawan_no_vendor_sppb', 'posisi_dinamis'));
    }
